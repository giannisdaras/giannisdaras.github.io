...
![](../images/ambient.png)
*<center>Figure 3: Training with corrupted data reduces the memorization of the training set.</center>*
...
*<center>Figure 4: Further evidence that Stable Diffusion XL has memorized images from the <a href="https://laion.ai/blog/laion-5b/">LAION</a> dataset.</center>*
...
*<center>Figure 8: The similarities between the generated samples and the training set are significantly reduced after training with corrupted data.</center>*
</center>
...
*<center>Figure 9: Ambient Diffusion for MRI acceleration.</center>*
